<template>
  <footer class="w-screen h-[160px] bg-sky-200 pt-6">
    <div
      class="flex flex-col gap-5 max-w-sm mx-auto px-6 items-center justify-center pt-7 p-4"
    >
      <p class="text-lg font-semibold text-gray-500 font-vazirmtn">
        Let's follow Eduzone.
      </p>
      <div class="flex gap-3">
        <a
          href="#"
          class="hover:scale-105 transform-scale duration-150 active:scale-95"
        >
          <svg
            ...
            viewBox="0 0 24 24"
            fill="#000"
            class="fill-blue-500 hover:fill-blue-700 transform-color duration-200"
          >
            <path
